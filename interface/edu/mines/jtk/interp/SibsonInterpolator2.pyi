...
class SibsonInterpolator2:
    ...
    @overload
    def __init__(self, method: Method, x1: Float1D, x2: Float1D) -> None:
        """
    ...
    @overload
    def __init__(self, method: Method, f: Float1D, x1: Float1D,
                 x2: Float1D) -> None:
        """
    ...
    def setGradients(self, g1: Float1D, g2: Float1D) -> None:
        """
    ...
    @overload
    def setBounds(self, x1min: float, x1max: float, x2min: float,
                  x2max: float) -> None:
        """
    ...
    @overload
    def setBounds(self, s1: Sampling, s2: Sampling) -> None:
        """
    ...
    def getIndexWeights(self, x1: float, x2: float) -> IndexWeight1D:
        """
