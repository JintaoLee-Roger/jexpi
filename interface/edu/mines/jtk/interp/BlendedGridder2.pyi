...
from edu.mines.jtk.dsp import Sampling, Tensors2


class BlendedGridder2:
    """
    ...
    @overload
    def gridNearest(self, pnull: float, p: Float2D) -> Float2D:
        """
    ...
    @overload
    def gridNearest(self, t: Float2D, p: Float2D) -> None:
        """
        Computes gridded values using nearest neighbors.
        Gridded values in the array p are computed for only unknown
    ...
    def gridBlended(self, t: Float2D, p: Float2D, q: Float2D) -> None:
        """
