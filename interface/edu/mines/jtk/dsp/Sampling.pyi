...
class Sampling:
    ...
    def __init__(self, n: int, d: double, f: double, t: double) -> None:
        ...
        f : double
            the first sample value.
        t : double
            the sampling tolerance, expressed as fraction of delta.
        """
    ...
    def isUniform(self) -> bool:
        ...
        the expression v = f+id, for sampling indices i = 0, 1, ..., n-1.
    ...
    def isInBoundsExtended(self, x: double) -> bool:
        ...
        [first-0.5delta,last+0.5delta] defined by the first and last sample
    ...
    def overlapWith(self, s: Sampling) -> Int1D:
        """
        ...
        -----------
        s : Sampling
            the sampling to compare with this sampling.
        
        Returns
        --------
        output : Int1D
            the array {n,it,is} that describes the overlap; null, if
        """
