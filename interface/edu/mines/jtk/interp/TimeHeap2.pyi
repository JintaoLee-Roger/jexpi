...
class TimeHeap2:
    ...
    def __init__(self, type: Type, n1: int, n2: int) -> None:
        """
    ...
    @overload
    def insert(self, i1: int, i2: int, time: float) -> None:
        """
    ...
    @overload
    def insert(self, i1: int, i2: int, time: float, mark: int) -> None:
        """
        Inserts a new entry into this heap with specified time and indices.
        The heap must not already contain an entry with those indices.
    ...
    def reduce(self, i1: int, i2: int, time: float) -> None:
        """
