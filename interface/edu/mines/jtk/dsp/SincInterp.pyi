...
class SincInterp:
    ...
    @staticmethod
    def fromErrorAndLength(self, emax: double, lmax: int) -> SincInterp:
        """
    ...
    @staticmethod
    def fromErrorAndFrequency(self, emax: double, fmax: double) -> SincInterp:
        """
    ...
    @staticmethod
    def fromFrequencyAndLength(self, fmax: double, lmax: int) -> SincInterp:
        """
