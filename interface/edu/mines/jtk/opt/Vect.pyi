...
class Vect(VectConst):
    ...
    def add(self, scaleThis: double, scaleOther: double,
        ...
        -----------
        scaleThis : double
            Multiply this vector by this scalar before adding.
        scaleOther : double
            Multiply the other vector by this scalar before adding.
        other : VectConst
            The other vector to be multiplied.
        """
    ...
    def project(self, scaleThis: double, scaleOther: double,
        ...
        -----------
        scaleThis : double
            The other vector to be projected, scaled, and added.
        scaleOther : double
            Multiply this vector by this scalar before adding.
        other : VectConst
            Multiply the other vector by this scalar before adding.
